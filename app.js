...
const embed = new Discord.RichEmbed()
   ...
   embed.addField(`${arrow.toString()} Owner`, `${message.guild.owner.user.tag}`, true)
   embed.addField(`${arrow.toString()} Members`, `${message.guild.memberCount - message.guild.members.filter(m=>m.user.bot).size} (${message.guild.members.filter(m=>m.user.bot).size} bots)`, true)
   embed.addField(`${arrow.toString()} Channels`, `${message.guild.channels.size}`, true)
   embed.addField(`${arrow.toString()} Created At`, `${message.guild.createdAt.toString().substr(0, 15)}`, true)
   embed.addField(`${arrow.toString()} Roles`, `${message.guild.roles.size}`, true)
   embed.addField(`${arrow.toString()} Region`, `${message.guild.region}`, true)
   embed.addField(`${arrow.toString()} ID`, `${message.guild.id}`, true)
   embed.addField(`${arrow.toString()} Verification`, `${message.guild.verificationLevel}`, true)
