...
const mentionPrefix = new RegExp(`^<@!?${client.user.id}> `);
 ...
 message.react("✅")
    ...
    .addField("Channel", `${message.channel.name !== null ? `${message.channel.name}` : "Direct Message"}`, false)
    .addField("Guild", `${message.guild.name !== null ? `${message.guild.name}` : "Direct Message"}`, false)
    .setColor("0xedca3d")
    .setTimestamp()
